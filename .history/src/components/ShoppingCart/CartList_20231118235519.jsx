  ...
  return productsCart.length ? (
    <div className="cart-list pb-8">
      <table className="table-auto w-full border-collapse border border-slate-500 mt-7">
        <thead>
          <tr>
            <th className="border border-slate-700">Tên sản phẩm</th>
            <th className="border border-slate-700">Số lượng</th>
            <th className="border border-slate-700">Số lượng còn lại</th>
        ...
        <tbody>
          ...
          <tr>
            <td className="text-lg font-bold ct-table-col">Thành tiền</td>
    ...
    <h3 className="font-bold text-xl text-blue-600 py-4">
